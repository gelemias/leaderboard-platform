/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df96f6e9e55b9749d4ea596a2fdbb4fa)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_REQUIRED" | "ENVIRONMENT">> {}
}
